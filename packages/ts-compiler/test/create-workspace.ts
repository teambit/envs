...
function enrichContentWithDefaults(content: WorkspaceContent, options: WorkspaceOptions) {
    content['package.json'] = content['package.json'] ? content['package.json'] : JSON.stringify({
        bit: {
            env: {
              compiler: {
                  meta: {
    ...
    content['.bitmap'] = content['.bitmap'] ? content['.bitmap'] : `/* THIS IS A BIT-AUTO-GENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY. */
    
    ${JSON.stringify({"version": "14.2.5"}, null, 4)}`
    
    content['.gitignore'] = content['.gitignore'] ? content['.gitignore'] : `dist\nnode_modules\n`
}